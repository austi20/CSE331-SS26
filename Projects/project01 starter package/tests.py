...
class DLLTests(unittest.TestCase):
    ...
    def test_dream_escaper(self):
        ...
        dll = DLL()
        dll.list_to_dll(
            ["Enter dream", "Outrun security guards", "Climb down trapdoor", "Escape danger", "Steal secret",
             "Profit"])
        dll2 = DLL()
        ...
        dll = DLL()
        dll.list_to_dll(
            ["Enter dream", "Open door to creepy house", "Make miraculous escape using spare grappling hook",
